def noncrossing_perfect_bondings(rna):
    ...
    def count_noncrossing(rna):
        ...
        splits = [i for i in range(1, len(rna), 2) if rna[0] == bonding[rna[i]] and check_subinterval(rna[1:i])]
...
rna = ""
